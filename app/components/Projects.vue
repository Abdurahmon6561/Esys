    ...
    <div class="container mx-auto mt-[65px] mb-[200px]">
        <div>
            <div class="flex justify-center items-center">
                <h3 class="text-sm text-[#080808] border-2 rounded-full p-2 border-[#EEE]">
                    Наши проекты
                </h3>
            </div>
            <div>
              ...
              <div class="flex justify-center items-center mt-12">
                <button class="px-5 hover:bg-[#EEE] text-[#080808] border-2 rounded-full p-2 border-[#EEE] font-medium">
                   Больше проектов
                </button>
            </div>
        </div>
